...
1. Fleksibilitas Parameter
Memungkinkan sebuah fungsi menerima berbagai kombinasi parameter dengan tipe yang berbeda-beda.

2. Menangani Return Type yang Berbeda
