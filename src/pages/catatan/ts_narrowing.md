...
1. Menghindari Error Runtime:
TypeScript memastikan bahwa kode kita aman dengan memeriksa tipe secara statis.

2. Meningkatkan Pembacaan Kode:
Narrowing membuat logika lebih jelas karena tipe ditentukan secara eksplisit.

3. Membantu Developer:
Editor kita (seperti VS Code) bisa memberikan autocomplete dan linting berdasarkan tipe yang lebih spesifik.
