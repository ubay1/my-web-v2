...
```md
my-nextjs-app/ │ ├── app/ │ ├── layout.js │ ├── page.js │ ├── about/ │ │ ├── page.js │ ├── blog/ │ │ ├── layout.js │ │ ├── page.js │ │ ├── [slug]/ │ │ │ ├── page.js │ ├── api/ │ │ ├── hello/ │ │ │ ├── route.js │ ├── globals.css │ ├── public/ │ ├── favicon.ico │ ├── components/ │ ├── Navbar.js │ ├── Footer.js │ ├── styles/ │ ├── Home.module.css │ ├── .gitignore ├── package.json ├── README.md └── next.config.js
```
