...
1. Membuat kode lebih terbaca: Dengan enum, kita bisa mengganti angka atau string "magic" dengan nama yang bermakna.

2. Mencegah kesalahan pengetikan: Karena nilai dalam enum sudah terdefinisi, TypeScript akan memberikan error jika kita menggunakan nilai yang salah.

3. Mempermudah debugging: Kamu bisa melihat nama konstan di log atau error alih-alih nilai mentahnya.

4. Digunakan untuk state atau kategori: Cocok untuk mendefinisikan status, peran, tipe data, atau kategori lainnya.
